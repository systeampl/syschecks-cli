...
var checkFields = []Field{
	...
	{Name: "content-match-attribute", JSONKey: "content_match_attribute", Kind: "string", Required: false, Help: "attribute to read when content-match-extract=attribute (e.g. href)"},
	...
	{Name: "content-match-extract", JSONKey: "content_match_extract", Kind: "string", Required: false, Help: "what to read from the selected elements: text, attribute"},
	{Name: "content-match-selector", JSONKey: "content_match_selector", Kind: "string", Required: false, Help: "CSS selector scoping the content match to part of the page"},
	{Name: "content-match-type", JSONKey: "content_match_type", Kind: "string", Required: false, Help: "content match type: contains, not_contains, regex, equals, exists, not_exists (last three need a selector)"},
